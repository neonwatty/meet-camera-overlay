...
(function() {
  ...
  function initializeSnapping() {
    ...
    if (typeof window.EdgeDetector === 'function') {
      // @ts-ignore - EdgeDetector is a constructor attached to window
    ...
    if (typeof window.SnapEngine === 'function') {
      // @ts-ignore - SnapEngine is a constructor attached to window
  ...
  function handleMouseMove(e) {
    ...
    if (isDraggingRegion && dragStartPoint && originalRegion) {
      ...
      const xs = [r.topLeft.x, r.topRight.x, r.bottomLeft.x, r.bottomRight.x];
      const ys = [r.topLeft.y, r.topRight.y, r.bottomLeft.y, r.bottomRight.y];
      ...
      currentRegion.topLeft = { x: o.topLeft.x + clampedDx, y: o.topLeft.y + clampedDy };
      currentRegion.topRight = { x: o.topRight.x + clampedDx, y: o.topRight.y + clampedDy };
      currentRegion.bottomLeft = { x: o.bottomLeft.x + clampedDx, y: o.bottomLeft.y + clampedDy };
      currentRegion.bottomRight = { x: o.bottomRight.x + clampedDx, y: o.bottomRight.y + clampedDy };
