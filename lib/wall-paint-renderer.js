...
export function renderWallPaintPerspective(ctx, region, color, options = {}) {
  ...
  if (featherRadius > 0) {
    const ctx = /** @type {CanvasRenderingContext2D} */ (/** @type {unknown} */ (tempCtx));
    applyEdgeFeathering(ctx, pixelRegion, featherRadius);
  }
...
if (typeof window !== 'undefined') {
  window.WallPaintRenderer = {
    renderWallPaint,
    renderWallPaintPerspective,
    renderAllWallPaint
  };
}
